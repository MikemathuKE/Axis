 ...
 * =============================================================================
/// ### Docking
/// Docking in general describes positions of windows and their dimensions
/// relative to one another. Each grouped batch of windows is described by the struct
/// nk_dockspace. <br /><br />
///
/// #### Reference
/// Flags                                   | Description
/// ----------------------------------------|------------------------------------
/// NK_DOCK_TOP                             | Assigns dockspace to top
/// NK_DOCK_LEFT                            | Assigns dockspace to left
/// NK_DOCK_RIGHT                           | Assigns dockspace to right
/// NK_DOCK_BOTTOM                          | Assigns dockspace to bottom
/// NK_DOCK_LOCK                            | Locks dockspace from removing or adding windows
/// NK_DOCK_FINAL                           | Locks all dockspaces and disables creation of new dockspaces
/// NK_DOCK_HAS_SUPER                       | Designates dockspace as managed by a window called the super window
///                                         |  a super window is defined by NK_WINDOW_DOCK_SUPER
*/
enum nk_dockspace_flags {
    NK_DOCK_TOP = NK_FLAG(0),
    NK_DOCK_LEFT = NK_FLAG(1),
    NK_DOCK_RIGHT = NK_FLAG(2),
    NK_DOCK_BOTTOM = NK_FLAG(3),

    NK_DOCK_LOCK = NK_FLAG(4),
    NK_DOCK_FINAL = NK_FLAG(5),
    NK_DOCK_HAS_SUPER = NK_FLAG(6)
};
/*/// #### nk_dockspace_init
/// Initializes all dockspace variables and sets dimensions of main window
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// void nk_dockspace_init(struct nk_context *ctx, int *width, int *height);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __width__   | Width of parent window
/// __height__  | Height of parent window
*/
NK_API void nk_dockspace_init(struct nk_context *ctx, int *width, int *height);
/*/// #### nk_dockspace_add_window
/// Designates window to be added, removed or relocated from a dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// void nk_dockspace_add_window(struct nk_context *ctx, struct nk_window* win);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window to be added to dockspace
*/
NK_API void nk_dockspace_add_window(struct nk_context *ctx, struct nk_window* win);
/*/// #### nk_dockspace_remove_window
/// Removes window from a dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// void nk_dockspace_remove_window(struct nk_context *ctx, struct nk_window* win);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window to be removed from dockspace
*/
NK_API void nk_dockspace_remove_window(struct nk_context *ctx, struct nk_window* win);
/*/// #### nk_dockspace_relocate
/// Moves an entire dockspace when NK_DOCK_HAS_SUPER flag is set
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// void nk_dockspace_relocate(struct nk_context *ctx, struct nk_dockspace* dck, nk_flags flag);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __dck__     | Dockspace to be relocated
/// __flag__    | New position flag of dockspace
*/
NK_API void nk_dockspace_relocate(struct nk_context *ctx, struct nk_dockspace* dck, nk_flags flag);
/*/// #### nk_dockspace_adjust
/// Adjusts dockspace positioning to accommodate any changes in size and position of dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// void nk_dockspace_adjust(struct nk_context *ctx, float width, float height);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __width__   | Width of main window
/// __height__  | Height of main window
*/
NK_API void nk_dockspace_adjust(struct nk_context *ctx, float width, float height);
/*/// #### nk_dockspace_set_highlight
/// Manages highlighting of possible dockspace positions. Each highlight will activate placing of a
/// window in a dockspace when the mouse hovers over the rect. It returns a rect for a highlight showing
/// dockspace position that is currently hovered
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// struct nk_rect nk_dockspace_set_highlight(struct nk_context *ctx, struct nk_rect *left, struct nk_rect *right,
...
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __left__    | Stores left highlight rect
/// __right__   | Stores right highlight rect
/// __top__     | Stores top highlight rect
/// __bottom__  | Stores bottom highlight rect
/// __inner__   | Stores inner highlight rect
*/
NK_API struct nk_rect nk_dockspace_set_highlight(struct nk_context *ctx, struct nk_rect *left, struct nk_rect *right,
                                       struct nk_rect *top, struct nk_rect *bottom, struct nk_rect *inner);
/*/// #### nk_dockspace_set_highlight
/// Returns a rect for possible dockspace position within an existing dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// struct nk_rect nk_dockspace_dock_inner_highlight(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
...
/*/// #### nk_dockspace_dock_highlight
/// Returns a rect for possible dockspace position based on assigned dockspace flag
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
/// struct nk_rect nk_dockspace_dock_highlight(const struct nk_context *ctx, nk_flags flag);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __flags__   | Flags selecting dockspace position
*/
NK_API struct nk_rect nk_dockspace_dock_highlight(const struct nk_context *ctx, nk_flags flag);
/*/// #### nk_dockspace_dock_highlight
/// Counts number of dockspaces that exist after the current dockspace in the linked list of dockspaces
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_set_count(struct nk_context *ctx, struct nk_dockspace *dck);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __dck__     | Dockspace whose count will be set
*/
NK_API void nk_dockspace_set_count(struct nk_context *ctx, struct nk_dockspace *dck);
/*/// #### nk_dockspace_set
/// Creates a new dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_set(struct nk_context *ctx, struct nk_window *win, nk_flags flag);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window that will be used to create new dockspace
/// __flag__    | Flag for position of dockspace
*/
NK_API void nk_dockspace_set(struct nk_context *ctx, struct nk_window *win, nk_flags flag);
/*/// #### nk_dockspace_assign_window
/// Handles moving of a window that already exists in a dockspace to another dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_assign_window(struct nk_context *ctx, struct nk_dockspace *dck,
                                     struct nk_window *win, struct nk_rect inner_bound);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter           | Description
/// --------------------|-----------------------------------------------------------
/// __ctx__             | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __dck__             | Dockspace that window will be assigned to
/// __win__             | Window that will change dockspaces
/// __inner_bound__     | rect of inner higlight
*/
...
/*/// #### nk_dockspace_append_window
/// Handles moving of a window without a dockspace into an existing dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_append_window(struct nk_context *ctx, struct nk_dockspace *dck,
                                     struct nk_window *win, struct nk_rect inner_bound);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter           | Description
...
/*/// #### nk_dockspace_set
/// Find the address of the dockspace where a window is. If window is not assigned to a dockspace
/// null will be returned
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  struct nk_dockspace* nk_dockspace_find_window(const struct nk_context *ctx, struct nk_window *win);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window to be assigned to dockspace
*/
NK_API struct nk_dockspace* nk_dockspace_find_window(const struct nk_context *ctx, struct nk_window *win);
/*/// #### nk_dockspace_scale_horizontally
/// Facilitates change in width of dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_scale_horizontally(struct nk_context *ctx, struct nk_window *win, float delta);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window facilitating scale
/// __delta__   | Change in dockspace width
*/
NK_API void nk_dockspace_scale_horizontally(struct nk_context *ctx, struct nk_window *win, float delta);
/*/// #### nk_dockspace_scale_vertically
/// Facilitates change in height of dockspace
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_scale_vertically(struct nk_context *ctx, struct nk_window *win, float delta);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window facilitating scale
/// __delta__   | Change in dockspace height
*/
NK_API void nk_dockspace_scale_vertically(struct nk_context *ctx, struct nk_window *win, float delta);
/*/// #### nk_dockspace_restore_window
/// Restores saved values of window positions and dimensions from ini file
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_restore_window(struct nk_context *ctx, struct nk_window *win);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __win__     | Window whose dimensions will be restored
*/
NK_API void nk_dockspace_restore_window(struct nk_context *ctx, struct nk_window *win);
/*/// #### nk_dockspace_restore
/// Restores saved values of dockspace positions and dimensions from ini file
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_restore(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
*/
NK_API void nk_dockspace_restore(struct nk_context *ctx);
/*/// #### nk_dockspace_end
/// Saves current state of windows and dockspaces to ini file
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_end(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
...
/*/// #### nk_dockspace_lock
/// Sets dockspace flag to NK_DOCK_LOCK. If dck parameter is null, the dockspace will be
/// initialized to the one containing the current window
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_lock(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __dck__     | Dockspace whose flag will be set
*/
NK_API void nk_dockspace_lock(struct nk_context *ctx, struct nk_dockspace *dck);
/*/// #### nk_dockspace_unlock
/// Removes dockspace flag NK_DOCK_LOCK. If dck parameter is null, the dockspace will be
/// initialized to the one containing the current window
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_unlock(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
///
/// Parameter   | Description
/// ------------|-----------------------------------------------------------
...
/// __dck__     | Dockspace whose flag will be set
*/
NK_API void nk_dockspace_unlock(struct nk_context *ctx, struct nk_dockspace *dck);
/*/// #### nk_dockspace_make_final
/// Sets or removes dockspace flag NK_DOCK_FINAL for the entire dockspace system
///
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~c
///  void nk_dockspace_unlock(struct nk_context *ctx);
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
/// ------------|-----------------------------------------------------------
/// __ctx__     | Must point to an previously initialized `nk_context` struct after call `nk_begin_xxx`
/// __final__   | if nk_true NK_DOCK_FINAL will be set, if nk_false NK_DOCK_FINAL will be unset
*/
NK_API void nk_dockspace_make_final(struct nk_context *ctx, nk_bool final);
/* =============================================================================
 *
 *                                  LAYOUT
 *
...
enum nk_window_flags {
    ...
    NK_WINDOW_DOCK_SUPER    = NK_FLAG(17)
    /* Sets Window as Head window of dockspace */
};
...
/* public: can be accessed freely */
    ...
    /* dockspace */
    nk_bool dock_restored;
    struct nk_dockspace dck;
    struct nk_rect dockable_space;
    struct nk_vec2 display_size;
