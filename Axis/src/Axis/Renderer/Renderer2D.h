...
#include "Axis/Renderer/EditorCamera.h"
...
namespace Axis {
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& subTexture, const float tilingFactor = 1.0f, const glm::vec4& tintColor = { 1.0f, 1.0f, 1.0f, 1.0f });
		static void DrawQuad(const glm::mat4& transform, const Ref<SubTexture2D>& subTexture, const float tilingFactor = 1.0f, const glm::vec4& tintColor = { 1.0f, 1.0f, 1.0f, 1.0f });
